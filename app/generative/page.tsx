      ...
      <main className="flex flex-col items-center justify-center min-h-screen bg-white p-10 text-gray-800">
        ...
        <div className="my-8 w-full md:w-2/3 lg:w-1/2 h-64 bg-gray-100 border-dashed border-2 border-gray-300">
          {selectedCategory === "summary" && (
            <p className="p-4 text-gray-800">{summary}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 w-full md:w-3/4 lg:w-1/2">
          <button
            disabled
            className="rounded-lg bg-blue-200 p-4 text-gray-700 font-medium hover:bg-blue-300 cursor-not-allowed opacity-50 pointer-events-none"
          >
            Land Use Pattern
          </button>
          <button
          ...
          <button
            className="rounded-lg bg-blue-200 p-4 text-gray-700 font-medium hover:bg-blue-300"
