...
export default function Index() {
  ...
  return (
    ...
    <Head>
        ...
        <meta name="description" content="Gia Jung is a computational designer and software engineer based in New York City. Harvard M.Arch, Sidewalk Labs, Google, Sequoia." />
    </Head>
    <main className="flex flex-col items-center justify-center min-h-screen bg-white p-10 text-gray-800">
      ...
      >
        ...
        {Object.entries(t[l].categories as Categories).map(([key, category]: [string, string]) => (
          <option value={key} key={key}>{category}</option>
        ))}
      </select></>)}
      <p className="text-lg">
      ...
      <footer className="absolute bottom-4">
        <p className="text-sm">
          ...
          <a href="https://www.linkedin.com/in/giajung/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600">{t[l].name as string}</a>
        </p>
      </footer>
    </main>
    </div>
